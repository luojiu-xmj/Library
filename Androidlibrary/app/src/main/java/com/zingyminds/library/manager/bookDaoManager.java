package com.zingyminds.library.manager;

import android.content.Context;

import com.zingyminds.library.Myapplication;
import com.zingyminds.library.model.bookmodel;
import com.zingyminds.library.model.bookmodelDao;
import com.zingyminds.library.utils.Datautils;
...
//    public List<bookmodel> queryByWriter(String writer) {
//        return  mbooksModelDao
//                .queryBuilder()
//                .where(bookmodelDao.Properties.Writer.eq(writer))
//                .list();
//    }
